...
// this all signIn or useSession which we extracting session is connected to 
// authProvider in which we hae signIn function 
...
const Navbar = () => {
  ...
  return (
    <nav className='bg-green-700 border-b border-blue-500'>
