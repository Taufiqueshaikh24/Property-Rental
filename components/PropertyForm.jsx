...
const PropertyForm = () => {
    ...
    const [fields  , setFields] = useState({
        ...
        const handleChange = (e) => {
                ...
                if(name.includes('.')){
                    // for nested object with the dot/period notataion 
                    // outerKey:location || rates , innerKey : street || nighlty 
                    const [outerKey , innerKey] = name.split('.');

                    setFields((prev) => ({
                        // spreading the previuos value
                        ...prev, 
                        // giving the value to outerkey with prevvalue of outer
                        [outerKey]:{
                            ...prev[outerKey], 
                            // giving value to inner key of the object by assign the value
                            [innerKey]: value
                        }
                    }))
                }else{
        ...
        const handleImageChange = (e) => {
              ...
              // Add new files to the array with for of loop 
              for(const file of files){
                   updatedImages.push(file);
              }
              // update the state array of images 
              setFields((prev) => ({
                   ...prev, 
