...
export default function Message({ message}){
      ...
      const handleReadClick = async (e) => {
              try {
                 const res = await fetch(`http://localhost:3000/api/v1/messages/${message._id}`, {
                    method:'PUT',
                    headers:{
        ...
        <div
              ...
              >
                <h2 className="text-xl mb-4">
                    {!isRead  && (
                        <>
                        <div className="absolute top-2 right-2 bg-green-700 text-white px-2 py-1 rounded-md">
                            New
                        </div>
                        </>
                    )}
                ...
                <ul className="mt-4">
                  ...
                  <li><strong>Received: </strong>{message.createdAt.toLocaleString()}</li>
                </ul>
